...
if len(sys.argv) != 7:
    print("Usage: python stockprice_lstm_tensorflow_regression.py trainFrom trainTo validationFrom validationTo testFrom testTo")
    print("Example: python stockprice_lstm_tensorflow_regression.py 20250501 20250531 20250601 20250607 20250701 20250707")
    sys.exit(1)
trainFrom, trainTo, validationFrom, validationTo, testFrom, testTo = sys.argv[1:7]
...
base_header = ['model_id', 'train_from', 'train_to', 'val_from', 'val_to', 'test_from', 'test_to', 'seq_length', 'learning_rate', 'epochs', 'batch_size', 'train_loss', 'train_mae', 'val_loss', 'val_mae']
base_row = [model_id_str, trainFrom, trainTo, validationFrom, validationTo, testFrom, testTo, seq_length, learning_rate, epochs, batch_size, train_loss, train_mae, val_loss, val_mae]
